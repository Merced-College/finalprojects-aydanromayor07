 ...
 * A square either has a value from 0-8 or is a mine.
 ...
 * If a square is opened, empty, unflagged, and isn't a mine, it prints " X "
 * If a sqaure is opened, isn't empty, unflagged, and isn't a mine, it prints its numerical value " n "
 * If a square is opened, unflagged, and is a mine, it shows the mine graphic " ó "
 */
...
public class Square {
    ...
    private final static String MINE_STRING = "ó";
